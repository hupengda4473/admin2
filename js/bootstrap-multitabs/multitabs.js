...
if (typeof jQuery === "undefined") {
    ...
    defaultLayoutTemplates = {
        ...
        iframeTabPane: '<iframe name="6666666666666" id="{tabPaneId}" class="tab-pane {class}"  width="100%" height="100%" frameborder="0" src="" seamless></iframe>'
    };
    ...
    MultiTabs.prototype = {
        ...
        _fixTabContentLayout: function (tabPane) {
            var $tabPane = $(tabPane);
            if ($tabPane.is('iframe')) {
                // $('body').addClass('full-height-layout').attr('data-theme','dark');
                // $('body').addClass('full-height-layout').attr('data-theme','translucent');
                // $('body').addClass('full-height-layout').attr('data-logobg','color_8').attr('data-sidebarbg','color_8').attr('data-headerbg','default');
                $('body').addClass('full-height-layout').attr('data-logobg','default').attr('data-sidebarbg','default').attr('data-headerbg','default');
